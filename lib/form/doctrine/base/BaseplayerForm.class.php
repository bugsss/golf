...
abstract class BaseplayerForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'home_course'      => new sfWidgetFormInputText(),
      'home_course_name' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'home_course'      => new sfValidatorString(array('max_length' => 64, 'required' => false)),
      'home_course_name' => new sfValidatorString(array('max_length' => 164, 'required' => false)),
